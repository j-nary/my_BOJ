...
int main() {
    vector<Edge> E;
    E.push_back(Edge(9, 1, 2));
    E.push_back(Edge(1, 1, 3));
    E.push_back(Edge(5, 1, 4));
    E.push_back(Edge(7, 2, 3));
    E.push_back(Edge(3, 2, 4));
    E.push_back(Edge(9, 3, 4));
    E.push_back(Edge(2, 3, 5));
    E.push_back(Edge(6, 4, 5));
